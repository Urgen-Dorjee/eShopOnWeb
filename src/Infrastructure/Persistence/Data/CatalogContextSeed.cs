...
namespace eWebShop.Persistence.Data
{
    ...
    {
        public static async Task SeedAsync(CatalogContext catalogContext, ILogger<CatalogContextSeed> logger, int? retry = 0)
        {
            ...
            try
            {
                ...
                {
                    catalogContext.CatalogBrands.AddRange(GetPreconfiguredCatalogBrands());
